...
export default class ActivityStreamsAttachments extends Vue {
  ...
  get getAttachments(): Array<Attachment> {
    ...
    const foo: Array<Attachment | undefined> = normalizedAttachments.map<Attachment | undefined>(
    ...
    return foo.filter<Attachment>(
      (item: Attachment | undefined) => item !== undefined
    );
  }
}
</script>
